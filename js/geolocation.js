...
function success(position) {
    ...
    let url = `https://www.openstreetmap.org/#map=16/${position.coords.latitude}/${position.coords.longitude}`;
...
if (!navigator.geolocation) {
    ...
    statusMsg.textContent = "Geolocation is no supported by your browser!";
} else {
